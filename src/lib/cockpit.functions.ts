  ...
  return deps.withAuth(token, async () => {
    ...
    try {
      const { input: ruleInput, missingFields } = deps.assembleRuleEngineInput({
        ...
        dkjord: null,
        plandataContext: analysisInput.plandataContext ?? null,
        arealdataContext: analysisInput.arealdataContext ?? null,
    ...
    const aiInput: ByggeanalyseInput = {
      ...
      lokalplaner: analysisInput.lokalplaner,
      plandataContext: analysisInput.plandataContext,
      arealdataContext: analysisInput.arealdataContext,
