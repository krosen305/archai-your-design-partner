    ...
    <PageTransition>
      <div className="max-w-2xl mx-auto px-6 py-10 space-y-6">
        ...
        <div>
          ...
          <h1 className="text-2xl font-medium text-foreground">Økonomi & Forsikring</h1>
        ...
        <Card>
          ...
          {vurderingData && !vurderingData.fejl ? (
            ...
            <p className="text-sm text-muted-foreground">
              Ejendomsvurdering hentes automatisk under byggeanalysen. Kør analysen for at se data
              her.
            </p>
          )}
        </Card>
