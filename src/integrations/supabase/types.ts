    ...
    Tables: {
      ...
      site_constraints: {
        Row: {
          ...
          fjernvarme_confidence: string | null;
          fjernvarme_daekket: boolean | null;
          fjernvarme_dokument_url: string | null;
          fjernvarme_fetched_at: string | null;
          fjernvarme_forsyningsforbud: boolean | null;
          fjernvarme_forsyningsselskab_cvr: string | null;
          fjernvarme_forsyningsselskab_navn: string | null;
          fjernvarme_plan_navn: string | null;
          fjernvarme_plan_slut_aar: number | null;
          fjernvarme_plan_start_aar: number | null;
          fjernvarme_planlagt: boolean | null;
          fjernvarme_source_kinds: string[] | null;
          fjernvarme_tilslutningspligt: boolean | null;
