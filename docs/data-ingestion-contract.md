...
export class MySourceService {
  static async getData(koordinat: { lat: number; lng: number }): Promise<SourceResult<MySourcePayload>> {
    if (IS_MOCK) {
    ...
    try {
      ...
      return makeOkResult(
        ...
        { kilde: "my-source", sourceUrl: "https://example.com/wfs", rawFeatureCount: features.length },
      );
    } catch (e) {
