...
export const complianceSuite: EvalSuite<ComplianceInput, ComplianceFlag[]> = {
  ...
  cases: [
...

    {
      ...
      expected: [
        ...
        },
        {
          ...
          status: "ok",
          detalje: null,
          aktuelVærdi: "Fritliggende enfamilieshus",
          tilladt: "Boligområde",
          kilde: "plandata",
        },
...

    {
      ...
      description: "Edge case: null BBR-data → kun etager + plandata-flags",
      scoring: "exact",
      threshold: 1.0,
      input: {
      ...
      // → bebyggelsesprocent-flag springes over; etager, bygningshoejde og anvendelse produceres
      expected: [
        {
          id: "etager",
          label: "Antal etager",
